...
# ╔═╡ 030c0001-0000-4000-8000-000000000001
begin
    import Pkg
    Pkg.activate(joinpath(@__DIR__, ".."))
end

# ╔═╡ 030c0001-0000-4000-8000-000000000002
using Markdown: @md_str, Markdown

# ╔═╡ 030c0001-0000-4000-8000-000000000003
using Statistics: mean, std

# ╔═╡ 030c0001-0000-4000-8000-000000000010
md"""
...
# ╔═╡ 030c0001-0000-4000-8000-000000000020
md"""
## Setup
...
# ╔═╡ 030c0001-0000-4000-8000-000000000030
import BasisSimulator as BS

# ╔═╡ 030c0001-0000-4000-8000-000000000031
import CairoMakie as CM

# ╔═╡ 030c0001-0000-4000-8000-000000000040
begin
    GPU_BACKEND = let
        candidates = [
...
# ╔═╡ 030c0001-0000-4000-8000-000000000050
md"""
**Backend detected:** $(GPU_BACKEND.name)
"""

# ╔═╡ 030c0002-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0002-0000-4000-8000-000000000010
...
# ╔═╡ 030c0002-0000-4000-8000-000000000020
phantom = BS.Phantom(
...
# ╔═╡ 030c0003-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0004-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0004-0000-4000-8000-000000000010
...
# ╔═╡ 030c0004-0000-4000-8000-000000000020
...
# ╔═╡ 030c0005-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0005-0000-4000-8000-000000000020
recon_opts = let
...
# ╔═╡ 030c0007-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0007-0000-4000-8000-000000000010
sim_low = let
...
# ╔═╡ 030c0008-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0008-0000-4000-8000-000000000010
sim_high = let
...
# ╔═╡ 030c0009-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0009-0000-4000-8000-000000000010
de_lohi_μ = let
...
# ╔═╡ 030c0006-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0006-0000-4000-8000-000000000010
kVp_μ_water = let
...
# ╔═╡ 030c0010-0000-4000-8000-000000000010
de_lohi_rskr = let
...
# ╔═╡ 030c0011-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0011-0000-4000-8000-000000000010
de_lohi_HU = let
...
# ╔═╡ 030c0012-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0012-0000-4000-8000-000000000010
de_cal = let
...
# ╔═╡ 030c0012-0000-4000-8000-000000000020
let
    rows = [
...
# ╔═╡ 030c0013-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0014-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0014-0000-4000-8000-000000000010
de_vmi_energies = [40.0, 70.0, 100.0, 140.0];

# ╔═╡ 030c0014-0000-4000-8000-000000000020
de_vmi_raw = let
...
# ╔═╡ 030c0016-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0016-0000-4000-8000-000000000010
de_vmi_mono = let
...
# ╔═╡ 030c0017-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0017-0000-4000-8000-000000000010
let
    ...
    CM.save(
        joinpath(@__DIR__, "..", "assets", "vmi_4panel_old.png"),
        fig; px_per_unit = 2,
    )
    fig
end

# ╔═╡ 030c0018-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0018-0000-4000-8000-000000000010
ROD_LABELS = (
...
# ╔═╡ 030c0018-0000-4000-8000-000000000020
ROD_NAMES = (
...
# ╔═╡ 030c0018-0000-4000-8000-000000000030
md"""
...
# ╔═╡ 030c0018-0000-4000-8000-000000000040
rod_data = let
...
# ╔═╡ 030c0019-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0019-0000-4000-8000-000000000010
let
    ...
    CM.save(
        joinpath(@__DIR__, "..", "assets", "vmi_vs_theoretical_old.png"),
        fig; px_per_unit = 2,
    )
    fig
end

# ╔═╡ 030c001a-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c001a-0000-4000-8000-000000000010
let
    ...
    CM.save(
        joinpath(@__DIR__, "..", "assets", "vmi_regression_old.png"),
        fig; px_per_unit = 2,
    )
    fig
end

# ╔═╡ 030c0020-0000-4000-8000-000000000001
md"""
...
# ╔═╡ 030c0020-0000-4000-8000-000000000010
let
...
# ╔═╡ 030c0021-0000-4000-8000-000000000001
md"""
## Summary
