...
over 3 × 3 × 7 voxels and its complement over 15 × 15 × 7 (the basis-spectral-denoising
study's chain; `SpectralHYPR()` on its own uses 5 × 5 × 7). The decomposition is the
