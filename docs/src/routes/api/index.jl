...
res = BS.apply_mono_plus!(ws, vols_in, energies; E_noise_opt = 70.0, σ_lp_px = σ_vec)""")),
        ...
        Div(:class => card_cls,
            Div(:class => sig_cls, "apply_bhc_two_material(sino, model, geom, matrix_size; volume_extent = nothing)"),
            P(:class => prose_cls,
        ...
        Div(:class => card_cls,
            Div(:class => sig_cls, "apply_bhc_image_domain(recon_μ, geom, matrix_size, μ_water; hu_low, hu_high, scale_factor, volume_extent)"),
            P(:class => prose_cls,
