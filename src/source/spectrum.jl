...
# Path to spectrum data files. The `.dat` tables were converted offline from `.mat` spectra
# generated by XCIST's spectrum generator (XCISTspectrum.m, github.com/xcist/main).
