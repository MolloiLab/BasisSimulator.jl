# The n-channel estimator exactly as notebook 04 (docs/notebooks/04_pcct_vmi.jl) published it before the
# notebook moved onto the package's `vmi_pipeline` (release 0.15.0; the cells are copied verbatim from
# commit 12acd9e). test/nchannel.jl evaluates them in a scratch module and runs them side by side with
# the package code: the port must stay equal to the published estimator. Do not edit.

# ── cell 4985581f-616d-4bb7-ab9b-967d7250b28b (controls) ────────────────────
nchannel_controls = (
...
# ── cell 73371177-0498-4eda-897b-651c94f43e83 (kernel) ────────────────────
begin
    """
...
# ── cell f3de45a6-4818-4ee1-ad56-c65797119dee (tlbf) ────────────────────
begin
